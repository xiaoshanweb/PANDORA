            ...
            <div class="product-pic">
                <div class="thumb-container">
                    <div class="thumb select">
                        <img src="../assets/img/image_04.jpg"    onclick="change(this.src)" alt="">
                    </div>
                    <div class="thumb">
                        <img src="../assets/img/image_17.jpg"    onclick="change(this.src)" alt="">
                    </div>
                    <div class="thumb">
                        <img src="../assets/img/image_10.jpg"    onclick="change(this.src)" alt="">
                    </div>
                    <div class="thumb">
                        <img src="../assets/img/image_05.jpg"    onclick="change(this.src)" alt="">
                    </div>
                </div>
                <div class="zomimg">
                    <img src="../assets/img/image_04.jpg" id="datu"  alt="">
                    <div class="zomimg-hover"></div>
                </div>
                <div class="big-zomimg">
                    <img src="../assets/img/image_31.jpg" id='datu1' alt="">
                </div>
